/**
 * Created by Daniel Sousa on 8/5/14. (The file not the code bitches)
 * https://raw.githubusercontent.com/yaptv/phonegap-plugin-facebook-connect/master/www/cdv-plugin-fb-connect.js
 */
...
CDV.FB = {
    ...
    login: function(params, cb, fail) {
        alert('In Login');
        params = params || { scope: 'email','public_profile' };
